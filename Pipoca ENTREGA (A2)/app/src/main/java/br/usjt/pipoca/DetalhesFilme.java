...
import br.usjt.pipoca.API.ResponseCredits;
import br.usjt.pipoca.API.ResponseCrew;
...
public class DetalhesFilme extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Filme filme = (Filme) intent.getSerializableExtra(Lista_Filmes.FILME);

        tituloTextView = findViewById(R.id.tituloFilme);
        direcaoTextView = findViewById(R.id.direcao_TextView);
